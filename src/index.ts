// Configure proxy before any other imports (for Discord WebSocket support)
...
async function main(): Promise<void> {
  ...
  // Start the native credential proxy (reads credentials from .env)
  await initCredentialProxy();
